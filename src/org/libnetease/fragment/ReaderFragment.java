 ...
 *
 */
public class ReaderFragment extends Fragment implements OnClickListener {
	...
	private void initViews() {
		...
		content=(TextView)parent.findViewById(R.id.reader_content);
		content.setText("¶©ÔÄÄÚÈÝ");
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_reader, null);
	}
