 ...
 *
 */
public class TiesFragment extends Fragment implements OnClickListener {
	...
	private void initViews() {
		...
		content=(TextView)parent.findViewById(R.id.ties_content);
		content.setText("¸úÌûÄÚÈÝ");
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_ties, null);
	}
